...
;;; Add local nicknames — uiop:define-package doesn't support :local-nicknames
(sb-ext:add-package-local-nickname :ffi :tree-sitter/ffi :tree-sitter/types)
(sb-ext:add-package-local-nickname :ffi :tree-sitter/ffi :tree-sitter/parser)
(sb-ext:add-package-local-nickname :types :tree-sitter/types :tree-sitter/parser)
(sb-ext:add-package-local-nickname :ffi :tree-sitter/ffi :tree-sitter/node)
(sb-ext:add-package-local-nickname :types :tree-sitter/types :tree-sitter/node)
(sb-ext:add-package-local-nickname :ffi :tree-sitter/ffi :tree-sitter/query)
(sb-ext:add-package-local-nickname :types :tree-sitter/types :tree-sitter/query)
(sb-ext:add-package-local-nickname :node :tree-sitter/node :tree-sitter/query)
(sb-ext:add-package-local-nickname :ffi :tree-sitter/ffi :tree-sitter/language)
(sb-ext:add-package-local-nickname :types :tree-sitter/types :tree-sitter/language)
